...
import cartSlice, { deleteFromCart } from '../../redux/cartSlice';
...
function Cart() {
    ...
    console.log(cartItems, "cartItem in cartjs mn")
    ...
    // useEffect for calculate the price 
    useEffect(() => {
        let result = 0;
        cartItems.forEach((item) => {
            result = result + parseInt(item.price)
        });
        // set price in the totalAmount 
                            ...
                            return (
                                <div className="justify-between mb-6 rounded-lg border  drop-shadow-xl bg-white p-6  sm:flex  sm:justify-start" style={{ backgroundColor: mode === 'dark' ? 'rgb(32 33 34)' : '', color: mode === 'dark' ? 'white' : '', }} key={index}>
                                    ...
                                    <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                                        ...
                                        <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6 " onClick={() => deleteCartItem(item)}>
